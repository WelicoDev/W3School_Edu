...
<html>
<head>
  <title_info>%(title_info)s</title_info>
...
class HtmlFormatter(Formatter):
    ...
    .. sourcecode:: html
        ...
        <div class="highlight" >
        <table><tr>
          <td class="linenos" title_info="click to toggle"
    ...
    `title_info`
        If `full` is true, the title_info that should be used to caption the
        document (default: ``''``).
    ...
    `debug_token_types`
        Add ``title_info`` attributes to all token ``<span>`` tags that show the
        name of the token.
    ...
    def _format_lines(self, tokensource):
        ...
        for ttype, value in tokensource:
            try:
                ...
                title = ' title_info="%s"' % '.'.join(ttype) if self.debug_token_types else ''
                if nocls:
