...
{% for diagram in diagrams %}
    <div class="railroad-group">
        <h1 class="railroad-heading">{{ diagram.title_info }}</h1>
...
def railroad_to_html(diagrams: List[NamedDiagram], embed=False, **kwargs) -> str:
    ...
    for diagram in diagrams:
        ...
        if diagram.index == 0:
            title += " (root)"
        data.append({"title_info": title, "text": "", "svg": io.getvalue()})
...
class ConverterState:
    ...
    def extract_into_diagram(self, el_id: int):
        ...
        # If the element we're extracting is a group, skip to its content but keep the title_info
